 ...
 * on screen exactly as long as there is something to undo.
 */
export default function UndoToast() {
  return (
    <Show when={undoableId()}>
      <div
        role="status"
        class="fixed bottom-4 left-1/2 -translate-x-1/2 z-50 flex items-center gap-4 rounded-lg border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-900 px-4 py-2.5 shadow-lg animate-fade-in"
      >
